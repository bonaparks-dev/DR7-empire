  ...
  const ticketBlocks = tickets.map(ticket => `
    <div style="background-color: #1a1a1a; border: 1px solid #333; border-radius: 8px; padding: 20px; margin-bottom: 15px; text-align: center;">
      ...
      <div style="margin-top: 15px; position: relative; display: inline-block; width: 128px; height: 128px;">
        <img src="https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=${ticket.uuid}&ecc=H&color=FFD700&bgcolor=000000" alt="Ticket QR Code" style="width: 120px; height: 120px; display: block; border: 4px solid #FFD700; border-radius: 4px;">
        <img src="https://firebasestorage.googleapis.com/v0/b/dr7-empire.appspot.com/o/DR7logo.png?alt=media" alt="DR7 Logo" style="position: absolute; top: 50%; left: 50%; width: 36px; height: 36px; margin-top: -20px; margin-left: -20px; background: #000000; padding: 2px; border-radius: 4px;">
      </div>
