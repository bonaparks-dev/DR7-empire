      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="mb-12 pb-12 border-b border-gray-900">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-400">DR7 Empire mantiene un rating impeccabile di 5.0/5.0 su quasi 300 recensioni verificate, confermandosi un punto di riferimento nel settore della luxury mobility.</p>
          </div>
          <ReviewsSection />
        </div>
