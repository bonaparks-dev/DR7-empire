...
export const GoogleIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg className={className} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
...
/** NEW: TikTok Icon **/
export const TiktokIcon: React.FC<IconProps> = ({ className = "w-6 h-6", ...props }) => (
  <svg
    viewBox="0 0 256 256"
    ...
    {...props}
  >
    <path d="M208.1 87.6c-19 0-36.5-6.9-50.2-18.4v77.2c0 36.3-29.4 65.7-65.7 65.7S26.5 182.7 26.5 146.4c0-33.7 25.5-61.5 58.2-65.3v28.6c-16.9 3.7-29.6 18.7-29.6 36.7 0 20.7 16.8 37.6 37.6 37.6s37.6-16.8 37.6-37.6V24.2h28.2c6.3 22.3 25.8 39.4 49.6 42.4v21.1z" />
  </svg>
);
