...
export const WhatsAppIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 175.216 175.552" className={className}>
    ...
    <path fill="url(#whatsapp-gradient)" d="M87.184 25.227c-33.733 0-61.166 27.423-61.178 61.13a61.05 61.05 0 0 0 8.258 30.682l-8.794 32.113 32.906-8.633a61.13 61.13 0 0 0 29.243 7.444h.025c33.733 0 61.166-27.423 61.178-61.13a60.98 60.98 0 0 0-17.895-43.445 60.9 60.9 0 0 0-43.443-18.161z"/>
