...
// Heroicons "UserCircle" outline — used for the account link in the header
// (replaces the previous gear/cog icon since the destination is the user
// profile page, not generic settings).
