...
export const translations: Translations = {
  ...
  DR7_is_your_gateway_to_a_world_of_unparalleled_luxury_From_supercars_to_jets_we_provide_access_to_the_extraordinary: { en: "DR7 is your gateway to a world of unparalleled luxury. From supercars to jets, we provide access to the extraordinary.", it: "DR7 è la tua porta d'accesso a un mondo di lusso senza pari. Dalle supercar ai jet, forniamo l'accesso allo straordinario." },
  ...
  ID_Documents: { en: "ID Documents", it: "Documenti di Identità" },
  Payment_Methods: { en: "Payment Methods", it: "Metodi di Pagamento" },
  Security: { en: "Security", it: "Sicurezza" },
  Preferences: { en: "Preferences", it: "Preferenze" },
  Help_Center: { en: "Help Center", it: "Centro Assistenza" },
  Login_and_Security: { en: "Login & Security", it: "Accesso e Sicurezza" },
  Two_Factor_Authentication: { en: "Two-Factor Authentication", it: "Autenticazione a Due Fattori" },
  Enable_2FA_to_add_an_extra_layer_of_security: { en: "Enable 2FA to add an extra layer of security to your account.", it: "Abilita 2FA per aggiungere un ulteriore livello di sicurezza al tuo account." },
  Enable: { en: "Enable", it: "Abilita" },
  Manage_your_connected_payment_methods: { en: "Manage your connected payment methods.", it: "Gestisci i tuoi metodi di pagamento collegati." },
  Add_Payment_Method: { en: "Add Payment Method", it: "Aggiungi Metodo di Pagamento" },
  Default: { en: "Default", it: "Predefinito" },
  Expires: { en: "Expires", it: "Scade" },
  Remove: { en: "Remove", it: "Rimuovi" },
  Manage_your_identity_documents_for_verification: { en: "Manage your identity documents for verification.", it: "Gestisci i tuoi documenti d'identità per la verifica." },
  Drivers_License: { en: "Driver's License", it: "Patente di Guida" },
  Passport: { en: "Passport", it: "Passaporto" },
  Verified: { en: "Verified", it: "Verificato" },
  Pending: { en: "Pending", it: "In Attesa" },
  Rejected: { en: "Rejected", it: "Respinto" },
  Not_Uploaded: { en: "Not Uploaded", it: "Non Caricato" },
  Upload: { en: "Upload", it: "Carica" },
  Uploaded_On: { en: "Uploaded On", it: "Caricato il" },
  Manage_your_notification_and_display_settings: { en: "Manage your notification and display settings.", it: "Gestisci le tue impostazioni di notifica e visualizzazione." },
  Notifications: { en: "Notifications", it: "Notifiche" },
  Promotional_Emails: { en: "Promotional Emails", it: "Email Promozionali" },
  Booking_Updates_via_SMS: { en: "Booking Updates via SMS", it: "Aggiornamenti Prenotazione via SMS" },
  Display: { en: "Display", it: "Visualizzazione" },
  Language: { en: "Language", it: "Lingua" },
  Currency: { en: "Currency", it: "Valuta" },
  Get_help_with_your_account_and_bookings: { en: "Get help with your account and bookings.", it: "Ottieni aiuto con il tuo account e le prenotazioni." },
  Frequently_Asked_Questions: { en: "Frequently Asked Questions", it: "Domande Frequenti" },
  Contact_Support: { en: "Contact Support", it: "Contatta il Supporto" },
