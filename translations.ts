...
export const translations: Translations = {
  ...
  Prizes_Pool_Text: { en: "Prize Pool Worth Over ", it: "Montepremi di Oltre " },
  Prizes_Pool_Value: { en: "$7,000,000", it: "7.000.000€" },
  ...
  Verification_Status_Pending_Desc: { en: 'Your submitted information is currently under review. This process usually takes 1-2 business days.', it: 'Le informazioni inviate sono in fase di revisione. Questo processo richiede solitamente 1-2 giorni lavorativi.' },
  ...
  Tell_us_about_your_asset: { en: "Tell us about your asset", it: "Parlaci del tuo bene" },
  Details_and_Specs: { en: "Details and Specs", it: "Dettagli e Specifiche" },
  Add_specific_features: { en: "Add specific features", it: "Aggiungi caratteristiche specifiche" },
  Showcase_Your_Asset: { en: "Showcase Your Asset", it: "Mostra il Tuo Bene" },
  Upload_high_quality_photos: { en: "Upload high-quality photos", it: "Carica foto di alta qualità" },
  Pricing_and_Publish: { en: "Pricing and Publish", it: "Prezzo e Pubblicazione" },
  Set_your_price_and_go_live: { en: "Set your price and go live", it: "Imposta il prezzo e vai online" },
  ...
  Upload_up_to_10_photos: { en: "Upload up to 10 photos", it: "Carica fino a 10 foto" },
  Drag_and_drop_or_click: { en: "Drag and drop photos here, or click to select files", it: "Trascina e rilascia le foto qui, o clicca per selezionare i file" },
  Main_photo_first: { en: "The first photo will be the main one.", it: "La prima foto sarà quella principale." },
  Review_Your_Listing: { en: "Review Your Listing", it: "Rivedi il Tuo Annuncio" },
  Youre_all_set: { en: "You're all set! Review the details below and publish your listing.", it: "È tutto pronto! Rivedi i dettagli qui sotto e pubblica il tuo annuncio." },
  Listing_Published: { en: "Listing Published!", it: "Annuncio Pubblicato!" },
  Your_listing_is_now_live: { en: "Your listing is now live on the DR7 platform.", it: "Il tuo annuncio è ora online sulla piattaforma DR7." },

  // Partner Settings
  New_Bookings: { en: "New Bookings", it: "Nuove Prenotazioni" },
  Get_notified_about_new_bookings: { en: "Get notified about new bookings for your assets.", it: "Ricevi notifiche per nuove prenotazioni dei tuoi beni." },
  ...
  Receive_updates_about_the_platform: { en: "Receive important updates and news about the partner platform.", it: "Ricevi aggiornamenti e notizie importanti sulla piattaforma partner." },
  ...
  'cookie.description': { en: 'We use cookies to enhance your browsing experience and analyze our traffic. By clicking "Accept", you consent to our use of cookies as described in our', it: 'Utilizziamo i cookie per migliorare la tua esperienza di navigazione e analizzare il nostro traffico. Cliccando "Accetta", acconsenti al nostro utilizzo dei cookie come descritto nella nostra' },
