...
export function useRealtimeBookings(
  ...
  const fetchBookings = useCallback(async () => {
    try {
      ...
      const columns = 'id,service_type,service_name,appointment_date,appointment_time,price_total,status,payment_status,payment_method,customer_name,customer_email,customer_phone,booking_source,created_at,vehicle_name,vehicle_id,pickup_date,dropoff_date,deposit_amount,booking_usage_zone';
