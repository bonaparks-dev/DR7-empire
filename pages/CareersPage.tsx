...
const CareersPage: React.FC = () => {
    ...
    return (
        <LegalPageLayout title={t('Careers')}>
            ...
            <p>If you believe you have what it takes to be a part of the DR7 Empire, please send your resume and a cover letter to amministrazione@dr7luxuryempire.com.</p>
        </LegalPageLayout>
    );
};
