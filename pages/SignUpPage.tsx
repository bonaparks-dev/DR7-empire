...
const SignUpPage: React.FC = () => {
    ...
    const validate = () => {
        ...
        } else if (passwordStrength < 1) { // Require at least 'Medium' strength
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        if (Object.keys(validationErrors).length === 0) {
            signup(formData.email, formData.fullName);
            navigate('/');
        }
    };
                    ...
                    >
                        ...
                        <form className="space-y-4" onSubmit={handleSubmit} noValidate>
                             ...
                             <div>
                                ...
                                <div className="relative">
                                    <input id="password" name="password" type={showPassword ? 'text' : 'password'} autoComplete="new-password" required
                                        className={getInputClassName('password')} placeholder={t('Password')}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input id="confirm-password" name="confirmPassword" type={showConfirmPassword ? 'text' : 'password'} autoComplete="new-password" required
                                        className={getInputClassName('confirmPassword')} placeholder={t('Confirm_Password')}
