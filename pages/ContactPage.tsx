      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-400 text-sm mt-2">Lun–Ven: 9:00–13:00 / 15:00–19:00</p>
            <p className="text-gray-400 text-sm">Sabato: 9:00–17:00</p>
        ...
        {/* Map — OpenStreetMap (no API key needed, always works) */}
        <div className="rounded-2xl overflow-hidden border border-gray-800">
          <iframe
            title="DR7 Empire – Sede Operativa Cagliari"
            src="https://www.openstreetmap.org/export/embed.html?bbox=9.1000%2C39.2200%2C9.1300%2C39.2300&layer=mapnik&marker=39.2253%2C9.1150"
            width="100%"
            height="400"
            style={{ border: 0 }}
            loading="lazy"
