...
const TermsOfServicePage: React.FC = () => {
    ...
    return (
        <LegalPageLayout title={t('Terms_of_Service')}>
            ...
            <p>DR7 provides an exclusive brokerage service, acting as an intermediary to connect you with a curated network of third-party owners and operators ("Owners") of luxury assets, including but not limited to supercars, yachts, villas, and private jets ("Assets").</p>
