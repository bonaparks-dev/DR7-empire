...
const CarWashBookingPage: React.FC = () => {
  ...
  const getAllTimeSlotsWithAvailability = () => {
    ...
    // Weekdays: 9:00-12:00 / 15:00-18:00 (lunch break 12:00-15:00)
    // Saturday: 9:00-17:00 continuous (no lunch break)
    ...
    const canFitInRange = (startTime: string, durationHours: number) => {
      ...
      // For 0.75-hour services (45 min - €25 LAVAGGIO COMPLETO)
