        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <motion.section className="bg-gray-900/50 border border-green-800/50 rounded-lg p-8" variants={itemVariants}>
              <h2 className="text-2xl font-bold text-white mb-4 border-b border-gray-700 pb-3">
                {lang === 'it' ? '7. Servizio opzionale "PRIME FLEX" (solo noleggio)' : '7. Optional "PRIME FLEX" service (rentals only)'}
              </h2>
              <p className="text-gray-300 leading-relaxed mb-4">
                {lang === 'it'
                  ? 'PRIME FLEX è un servizio opzionale acquistabile in fase di prenotazione del noleggio. Non è applicabile ad altri servizi.'
                  : 'PRIME FLEX is an optional service purchasable when booking a rental. It does not apply to other services.'}
              </p>
              ...
              <p className="text-gray-400 leading-relaxed italic">
                {lang === 'it'
                  ? 'In assenza dell\u2019acquisto del servizio PRIME FLEX (o DR7 FLEX), si applica integralmente la presente policy standard.'
                  : 'In the absence of purchasing the PRIME FLEX (or DR7 FLEX) service, this standard policy applies in full.'}
              </p>
            </motion.section>
          </motion.div>
