...
const AdminDocumentsPage: React.FC = () => {
  ...
  const viewDocument = async (doc: CustomerDocument) => {
    try {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Visualizza e gestisci tutti i documenti caricati dai clienti
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-800 border border-gray-700 rounded-md px-4 py-2 text-white focus:outline-none focus:border-white"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">
