                    ...
                    >
                        <AnimatePresence mode="wait">
                            {!submitted ? (
                                    ...
                                    <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="appearance-none rounded-md relative block w-full px-3 py-3 border border-stone-700 bg-stone-800 text-white placeholder-stone-400 focus:outline-none focus:ring-amber-500 focus:border-amber-500 focus:z-10 sm:text-sm"
                                ...
                                >
                                    <motion.div initial={{scale:0}} animate={{scale:1}} transition={{type: 'spring', stiffness: 260, damping: 20, delay: 0.2}} className="w-16 h-16 bg-amber-500/20 text-amber-400 rounded-full flex items-center justify-center mx-auto mb-6">
