    ...
    >
      <div className="pt-32 pb-24 bg-black">
        <div className="container mx-auto px-6">
          ...
          {/* Yacht Service Unavailable Banner */}
          {categoryId === 'yachts' && (
            <motion.div
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
              className="mb-8 bg-gradient-to-r from-yellow-900/30 to-orange-900/30 border-2 border-yellow-500/50 rounded-2xl p-8 text-center"
            >
              <div className="flex flex-col items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xl text-yellow-300/90 mb-4">
                    La sezione Yachting è attualmente in fase di sviluppo
                  </p>
                  <p className="text-gray-300 max-w-2xl mx-auto">
                    Stiamo lavorando per offrirti un'esperienza di noleggio yacht di altissimo livello.
                    Il servizio sarà disponibile a breve. Per informazioni, contattaci direttamente.
                  </p>
                </div>
                <button
                  onClick={() => window.location.href = 'https://wa.me/393517375375?text=Ciao%2C%20vorrei%20informazioni%20sul%20servizio%20Yachting'}
                  className="mt-4 bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-full font-semibold transition-colors flex items-center gap-2"
                >
